        ...
        execute: function () {
            class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    try {
                        ...
                        if (err instanceof DataInvalidaException) {
                            //testa se o erro é de data e exibe a msg ao usuário caso positivo
                            this._mensagem.texto = err.message;
                        } else {
                            //caso não seja um erro de data, exibe msg genérica
                ...
                importaNegociacoes() {
                    ...
                    .obtemNegociacoesDoPeriodo().then(negociacoes => {
